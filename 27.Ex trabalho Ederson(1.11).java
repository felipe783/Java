...
/*String[] alfabeto=new String[10];
-isso basicamente separa um espaço na memoria por causa do "NEW",resumindo isso deixa todas as posições vazias,e o usuario
ira preencher futuramente,sem o new ele ja define os valores nas posição
-Em resumo sem o new é bom vc ja deixar definido os valores

A diferença entre o ' e " é que a simples pega so um caracter e a dupla transforma em string*/
...
public class Main{
    public static void main(String[] args){
        ...
        String senha;
        int i = 0,j=0,cont_Letras=0,cont_Numeros=0;
        //Dados
